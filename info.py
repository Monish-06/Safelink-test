...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "Join @moxi_movies /n/n files will be automatically deleted after 10minutes due to copyright problems 😊 /nSave it Or forward it to your friend 😄👊")
